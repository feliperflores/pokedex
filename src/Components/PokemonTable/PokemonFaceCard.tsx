...
const PokemonFaceCard = ({ pokemon: { id, name, types, sprites } }: PokemonFaceCardProps) => (
  <div className="min-w-56 group border-2 border-gray-300 rounded p-2 bg-gray-100 transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 hover:border-gray-400 duration-200">
